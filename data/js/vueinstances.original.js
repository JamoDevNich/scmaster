...
var vueMainInterface = new Vue({
    ...
    methods: {
        ...
        trackNext: function(b) {
            // notes: getTrack needs to return track id. We use that to create a for loop,
            // set current location in loop to the song id, and go backwards until we find Something
            // we can play. if same song is encountered, then stop playback.
